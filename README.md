Gradle Watch Plugin 0.1.0 [![Build Status](https://travis-ci.org/bluepapa32/gradle-watch-plugin.png?branch=develop)](https://travis-ci.org/bluepapa32/gradle-watch-plugin)
=========================
